package com.skullmangames.biohazard.entity.ai.goal;
...
public class CerberusAttackGoal extends Goal {
    protected final CerberusEntity attacker;
    ...
    public CerberusAttackGoal(CerberusEntity creature, double speedIn, boolean useLongMemory) {
    ...
    protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
        if (distToEnemySqr <= 4 && this.attackTick <= 0) {
            this.attackTick = 20;
            this.attacker.attackJump((enemy.getPosX() - this.attacker.getPosX()) / 2, (enemy.getPosZ() - this.attacker.getPosZ()) / 2);
